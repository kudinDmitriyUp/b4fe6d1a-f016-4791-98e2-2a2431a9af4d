...
export const metadata: Metadata = {
  title: "Premium Basketballs | BasketPro Sports",
  description: "Shop professional-grade basketballs for indoor and outdoor play. Quality equipment for athletes of all levels.",
  keywords: "basketball, sports equipment, indoor basketball, outdoor basketball, league approved",
  openGraph: {
    title: "Premium Basketballs | BasketPro Sports",
    description: "Shop professional-grade basketballs for indoor and outdoor play.",
    siteName: "BasketPro",
    type: "website"
  },
  robots: {
